...
placeholder content — `Evan Burns`, a generic hero image, and so on.
...
> Replace every "Evan Burns" placeholder in this site with my name,
...
- [ ] Your name, replacing `Evan Burns` everywhere it appears.
